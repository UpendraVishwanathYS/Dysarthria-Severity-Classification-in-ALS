...
class ALSModelTrainerW2V2:
    def __init__(self, train_data_path, test_data_path,  w2v2_feature_path, classification_type, exp_name):
        self.train_data_path = train_data_path
        self.test_data_path = test_data_path
        self.classification_type = classification_type
        self.exp_name = exp_name
        self.w2v2_feature_path = w2v2_feature_path
        self.fold_metrics = []
    ...
    def process_data(self, i):
        ...
        w2v2_features_data = pd.read_csv(self.w2v2_feature_path)
        ...
        train_data = w2v2_features_data[train_files['Audio_file_name'].unique()]
        train_labels = [train_files.loc[train_files['Audio_file_name'] == x, 'Severity'].values[0] for x in train_data.columns]
        test_data = w2v2_features_data[test_files['Audio_file_name'].unique()]
